...
targets = DesignTargets(
    continuous_targets=[ContinuousTarget(label="cosine_similarity", lower_bound=0.75, upper_bound=1)]
)

data_package = DataPackage(features_dataset=get_features_dataset(),
